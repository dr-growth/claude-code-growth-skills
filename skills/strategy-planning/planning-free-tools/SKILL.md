...
- **optimizing-pages**: For optimizing the tool's landing page
- **auditing-seo**: For SEO-optimizing the tool
- **tracking-analytics**: For measuring tool usage
- **designing-email-sequences**: For nurturing leads from the tool
