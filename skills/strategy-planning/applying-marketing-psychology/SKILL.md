...
**Full mental models library also available at**: [references/mental-models.md](references/mental-models.md)
...
- **optimizing-pages**: Apply psychology to page optimization
- **writing-copy**: Write copy using psychological principles
- **optimizing-popups**: Use triggers and psychology in popups
- **pricing-page optimization**: See optimizing-pages for pricing psychology
- **setting-up-ab-tests**: Test psychological hypotheses
