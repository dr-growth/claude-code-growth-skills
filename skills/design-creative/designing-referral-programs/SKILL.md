---
name: designing-referral-programs
...
- **planning-launches**: For launching referral program effectively
- **designing-email-sequences**: For referral nurture campaigns
- **applying-marketing-psychology**: For understanding referral motivation
- **tracking-analytics**: For tracking referral attribution
